...
object Visualization {
  ...
  def predictTemperature(temperatures: Iterable[(Location, Temperature)], location: Location): Temperature = {
    predictTemperatureV1(temperatures, location)
  }
  ...
  def interpolateColor(points: Iterable[(Temperature, Color)], value: Temperature): Color = {
    interpolateColorV1(points, value)
  }
  ...
  def visualize(temperatures: Iterable[(Location, Temperature)], colors: Iterable[(Temperature, Color)]): Image = {
    visualizeV1(temperatures, colors)
  }
  ...
  /**
    ...
    * @return A 360×180 image where each pixel shows the predicted temperature at its location
    */
  def visualizeV1(temperatures: Iterable[(Location, Double)], colors: Iterable[(Double, Color)]): Image = {
    val imageWidth = 360
    val imageHeight = 180
    ...
    val pixels = (0 until imageHeight * imageWidth).par.map {
      pos =>
        pos -> interpolateColorV1(
          colors,
          predictTemperatureV1(
            temperatures,
            locationMap(pos)
          )
        ).pixel()
  ...
  /**
    ...
    * @return The predicted temperature at `location`
    */
  def predictTemperatureV1(temperatures: Iterable[(Location, Double)], location: Location): Double = {
  ...
  /**
    ...
    * @return The color that corresponds to `value`, according to the color scale defined by `points`
    */
  def interpolateColorV1(points: Iterable[(Double, Color)], value: Double): Color = {
