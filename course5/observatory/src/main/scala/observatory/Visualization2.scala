...
object Visualization2 {
    ...
    val pixels = pixelLocations(x, y, zoom, imageWidth, imageHeight).par.map{
      case (pos,pixelLocation) => {
        ...
        pos -> interpolateColor(
          colors,
          bilinearInterpolation(CellPoint(x=xFraction, y=yFraction), d00=d((0,0)), d01=d((0,1)), d10=d((1,0)), d11=d((1,1)))
        ).pixel(127)
      }}
      .seq
      .sortBy(_._1)
  ...
  /**
    ...
    */
  def pixelLocations(offsetX: Double, offsetY: Double, zoom: Int, imageWidth: Int, imageHeight: Int):immutable.IndexedSeq[(Int, Location)] = {
    for{
